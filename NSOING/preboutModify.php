...
<html lang="en">
  ...
  while(mysqli_stmt_fetch($prepara)){
    $boutUser=$boutUser.'<div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300"><a href="preboutUpdate.php?id='.$idUser.'&idLeage='.$idLeage.'&idBout='.$idBout.'" class="unit-9 "><div><img src="user/imagenes/bout/'.$boutPhoto.'" alt="'.$bout.'" class="image"></div><div class="unit-9-content"><h2>'.$bout.'</h2><span>'.$boutDate.'</span><span>Game'.$game.'</span></div></a></div>';
  }
